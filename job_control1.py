...
class job_control:
    job_control_table=os.environ.get("APP_JOB_CONTROL_TABLE")
    job_status_table=os.environ.get("APP_JOB_STATUS_TABLE")
    job_dependency_table=os.environ.get("APP_JOB_DEPENDENCY_TABLE")
    profile_name=os.environ.get("APP_AWS_PROFILE")
    ...
    def checkdependency(self,job_id):
